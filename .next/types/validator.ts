...
// Validate ../../src/app/api/protected-example/route.ts
{
  const handler = {} as typeof import("../../src/app/api/protected-example/route.js")
  handler satisfies RouteHandlerConfig<"/api/protected-example">
}
